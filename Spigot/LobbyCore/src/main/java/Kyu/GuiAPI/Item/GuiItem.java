package Kyu.GuiAPI.Item;

import Kyu.GuiAPI.Util.Util;
import Kyu.GuiAPI.Windows.DefaultWindow;
...
public class GuiItem {
    ...
    public void relocatePage(int slot, int page) {
        GuiItem itemOnOldSlot = ((DefaultWindow) parentWindow).getGuiItemFromPage(getSlot(), getPage(), true);
